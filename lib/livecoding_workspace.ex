defmodule LivecodingWorkspace do
  use Application
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: LivecodingWorkspace.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    LivecodingWorkspace.Endpoint.config_change(changed, removed)
    :ok
  end
end
